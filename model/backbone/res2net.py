...
model_urls = {
    ...
    'res2net_v1b_101': 'https://shanghuagao.oss-cn-beijing.aliyuncs.com/res2net/res2net101_v1b_26w_4s-0812c246.pth',
}
...
class Res2Net(nn.Module):
    ...
    def get_blocks0(self, x, H, W):
        x = self.layer1(x)
        return x

    def get_blocks1(self, x):
        x = self.layer2(x)
        return x
    def get_blocks2(self, x):
        x = self.layer3(x)
        return x
    def get_blocks3(self, x):
        x = self.layer4(x)
        return x
