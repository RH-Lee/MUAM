...
class FE_Block(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        middle_channel = int(out_channel / 2)
        self.relu = nn.ReLU(True)
        self.branch0 = nn.Sequential(
            BasicConv2d(in_channel, middle_channel, 1),
        )
        self.branch1 = nn.Sequential(
            BasicConv2d(in_channel, middle_channel, 1),
            BasicConv2d(middle_channel, middle_channel, kernel_size=(1, 3), padding=(0, 1)),
            BasicConv2d(middle_channel, middle_channel, kernel_size=(3, 1), padding=(1, 0)),
            BasicConv2d(middle_channel, middle_channel, 3, padding=3, dilation=3),
            ChannelAttention(middle_channel)
        )
        self.branch2 = nn.Sequential(
            BasicConv2d(in_channel, middle_channel, 1),
            BasicConv2d(middle_channel, middle_channel, kernel_size=(1, 5), padding=(0, 2)),
            BasicConv2d(middle_channel, middle_channel, kernel_size=(5, 1), padding=(2, 0)),
            BasicConv2d(middle_channel, middle_channel, 3, padding=5, dilation=5),
            ChannelAttention(middle_channel)
        )
        self.branch3 = nn.Sequential(
            BasicConv2d(in_channel, middle_channel, 1),
            BasicConv2d(middle_channel, middle_channel, kernel_size=(1, 7), padding=(0, 3)),
            BasicConv2d(middle_channel, middle_channel, kernel_size=(7, 1), padding=(3, 0)),
            BasicConv2d(middle_channel, middle_channel, 3, padding=7, dilation=7),
            ChannelAttention(middle_channel)
        )
        ...
        self.branch5 = nn.Sequential(
            BasicConv2d(in_channel, middle_channel, 1),
            BasicConv2d(middle_channel, middle_channel, kernel_size=(1, 6), padding=(0, 1)),
            BasicConv2d(middle_channel, middle_channel, kernel_size=(6, 1), padding=(1, 0)),
            BasicConv2d(middle_channel, middle_channel, 3, padding=6, dilation=6),
            ChannelAttention(middle_channel)
        )
        self.branch6 = nn.Sequential(
            BasicConv2d(in_channel, middle_channel, 1),
            BasicConv2d(middle_channel, middle_channel, kernel_size=(1, 12), padding=(0, 2)),
            BasicConv2d(middle_channel, middle_channel, kernel_size=(12, 1), padding=(2, 0)),
            BasicConv2d(middle_channel, middle_channel, 3, padding=12, dilation=12),
            ChannelAttention(middle_channel)
        )
        self.branch7 = nn.Sequential(
            BasicConv2d(in_channel, middle_channel, 1),
            BasicConv2d(middle_channel, middle_channel, kernel_size=(1, 18), padding=(0, 3)),
            BasicConv2d(middle_channel, middle_channel, kernel_size=(18, 1), padding=(3, 0)),
            BasicConv2d(middle_channel, middle_channel, 3, padding=18, dilation=18),
            ChannelAttention(middle_channel)
        )
    ...
    def forward(self, x):
        x0 = self.branch0(x)
        # print(x0.shape)   #torch.Size([8, 16, 64, 64])
        size = x0.shape[2:]
        x1 = self.branch1(x)
        x2 = self.branch2(x)
        ...
        x5 = F.interpolate(x5, size, mode='bilinear')
        x6 = F.interpolate(x6, size, mode='bilinear')
        x7 = F.interpolate(x7, size, mode='bilinear')
